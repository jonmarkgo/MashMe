...
$e_apikey = 'VZ6AQRO0XGTPJNMAF';
  ...
  curl_setopt($ch, CURLOPT_URL, 'http://api.bit.ly/v3/shorten?login=jonmarkgo&apiKey=R_d46cb69c34a01e05200545a472a42312&format=txt&longUrl='.urlencode('http://127.0.0.1/'.$mashuptmp));
    $result3 = curl_exec($ch);
    echo '<h1>YOU\'VE BEEN MASHED</h1><br><b>Mashed up '.$songs[0]->title.' by '.$songs[0]->artist.' and '.$songs[1]->title.' by '.$songs[1]->artist.' for you at: <a href="'.$result3.'">'.$result3.'</a></b><br><a href="http://twitter.com/share" class="twitter-share-button" data-url="'.$result3.'" data-text="Check out my personalized MashUp!" data-count="none" data-via="jonmarkgo">Tweet</a><script type="text/javascript" src="http://platform.twitter.com/widgets.js"></script><iframe src="http://www.facebook.com/plugins/like.php?href='.urlencode($result3).'&amp;layout=button_count&amp;show_faces=false&amp;width=450&amp;action=recommend&amp;colorscheme=light&amp;height=21" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:450px; height:21px;" allowTransparency="true"></iframe>';
